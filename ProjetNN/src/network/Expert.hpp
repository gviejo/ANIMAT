...
public: 
  ...
  void initGradient();
  void gradientStep(double epsilon_gradient, SPTR<Vector> input, SPTR<Vector> output, float proba_gate, float epsilon, float eta);
  void updateGradient(double epsilon);
